...
function SectionBlockTypeSelect({ classes, blockType, setBlockType }) {
  ...
  const questionTypes = useMemo(
    () => [blockTypes.freetext, blockTypes.multiselect, blockTypes.yesno, blockTypes.singleselect, blockTypes.number, blockTypes.dropdown, blockTypes.scale],
    []
  );
  ...
  return (
    <FormControl className={classes.formControl}>
      ...
      <Select labelId="single-checkbox-label" value={blockType} onChange={handleChange} error={blockType === 'question'}>
